...
CREATE  TABLE IF NOT EXISTS tweets_master(
tweet_text string,
id string,
name string,
source string
...
LOCATION '/tmp/output/tweets/blackfriday';

LOAD DATA INPATH '/tmp/output/tweets/blackfriday/part-r-00000_copy_1_copy_1' into table default.tweets_master;
